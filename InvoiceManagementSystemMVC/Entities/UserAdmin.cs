...
namespace InvoiceManagementSystemMVC.Entities
{
    ...
    public class UserAdmin
    {
        ...
        public ICollection<Message> MessagesSent { get; set; } // Kullanıcının gönderdiği mesajlar
        public ICollection<Message> MessagesReceived { get; set; } // Kullanıcının aldığı mesajlar
    }
